...
class Recipe(models.Model):
	...
	final_volume = models.DecimalField(u"volume left after fermentation", max_digits=4, decimal_places=2, default=12)
...
class BrewingSession(models.Model):
	...
	final_volume = models.DecimalField(u"scale adjusted final volume", max_digits=4, decimal_places=2, default=0)
	measured_final_volume = models.DecimalField(u"measured final volume", max_digits=4, decimal_places=2, default=0)
	boil_time = models.IntegerField(u"time to boil in minutes", default=60)
