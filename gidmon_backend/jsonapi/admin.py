...
admin.site.register(models.BrewingSessionComment)
...
admin.site.register(models.PitchType)
admin.site.register(models.BoilSessionEntry)
admin.site.register(models.MashSessionEntry)
